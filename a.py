...
spark = SparkSession.builder \
    ...
    .config("spark.jars", "s3://finalproject1-a/spark-sql-kafka-0-10_2.12-3.2.1.jar,s3://finalproject1-a/kafka-clients-2.1.1.jar") \
    .getOrCreate()
...
query = result.writeStream \
    .outputMode("append") \
    .foreachBatch(lambda df, epoch_id: (df.drop("first", "last", "job", "profile").write.mode("append").format("parquet").save("s3://finalproject1-b/sparkwrite/"))) \
    .start()
